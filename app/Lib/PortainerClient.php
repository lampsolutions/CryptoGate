...
class PortainerClient
{
     ...
     * @return Path
     */
    public function resource_controls(): Path
    {
        $path = $this->client->createPath('resource_controls');
     ...
     * @return Path
     */
    public function containers(int $endpointId): Path
    {
        $path = $this->client->createPath("endpoints/{$endpointId}/docker/containers/json");
     ...
     * @return Path
     */
    public function containerRestart(int $endpointId,string $container): Path
    {
        $path = $this->client->createPath("endpoints/{$endpointId}/docker/containers/{$container}/restart");
